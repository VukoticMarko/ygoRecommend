CREATE TABLE `archetype_attribute` (
  `archetype_id` varchar(36) NOT NULL,
  `attribute` varchar(45) NOT NULL,
  PRIMARY KEY (`archetype_id`,`attribute`)
